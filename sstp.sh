...
wget -O /etc/accel-ppp.conf "https://vpnasian.com/autoscript/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://vpnasian.com/autoscript/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://vpnasian.com/autoscript/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://vpnasian.com/autoscript/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://vpnasian.com/autoscript/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
