...
cd /usr/bin
wget -O add-ss "https://vpnasian.com/autoscript/add-ss.sh"
wget -O del-ss "https://vpnasian.com/autoscript/del-ss.sh"
wget -O cek-ss "https://vpnasian.com/autoscript/cek-ss.sh"
wget -O renew-ss "https://vpnasian.com/autoscript/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
